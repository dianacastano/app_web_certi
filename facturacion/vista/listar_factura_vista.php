...
<body class="bg-body-secondary lead">
    <div class="container">
        <div class="card " style="margin-top: 150px; width: auto; box-shadow: 0 0 10px rgba(0,0,0.3); ">
            <h2 class="text-center lead" style="font-size: xx-large;"><strong>Listado de Contactos</strong></h2>
            <table class="bg-dark-subtle">
                <thead>
