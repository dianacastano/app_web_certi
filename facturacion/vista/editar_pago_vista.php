...
<h2 class="text-center lead" style="border-radius:5px; font-size:xx-large"><strong> Selecciona ID </strong></h2>
        ...
        <form action="form_pagos_vista.php" method="GET">
            <div class="form-group">
                <label for="id_pago" class=" font-weight-bold">ID de Pago:</label>
