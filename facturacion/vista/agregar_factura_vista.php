...
<body>
    ...
    <h2 class="text-center lead" style="border-radius:5px; font-size:xx-large"><strong> Registro de Factura en Base De Datos </strong></h2>
        <form method="POST" action="../controlador/controlador_facturacion.php">
            <input type="hidden" name="action" value="agregarFactura">
            ...
            <div class="form-group">
                ...
                <input type="text" id="impuestos" name="impuestos" class="form-control" required>
            </div>
            <div class="form-group">
                <label for="descuentos">Descuentos:</label>
                <input type="text" id="descuentos" name="descuentos" class="form-control" required>
            </div>
            <div class="form-group">
                <label for="total_final">Total Final:</label>
                <input type="text" id="total_final" name="total_final" class="form-control" required>
            </div>
            <div class="form-group">
