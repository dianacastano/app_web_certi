...
<h2 class="text-center lead" style="font-size: xx-large; border-radius:5px;""><strong>Selecciona ID</strong></h2>
        ...
        <form action="form_editar_vista.php" method="GET">
            <div class="form-group">
                <label for="id_factura" class=" font-weight-bold">ID de Factura:</label>
