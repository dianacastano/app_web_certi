...
<head>
    ...
    <style>
        body {
            background-image: url('../vistas/img/imagen7.jpg');
...
<body>
    <div class="container mt-5">
        <h2 class="text-center" style="background-color: blanchedalmond;">Consultar Factura</h2>
        ...
        <form method="GET" action="../controlador/controlador_facturacion.php">
