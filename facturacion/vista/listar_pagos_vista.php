            ...
            <table class="bg-dark-subtle table table-striped">
                <thead>
                    <tr style="background-color: lightgrey;">
                        <th class="lead"><strong>ID Pago</strong></th>
                        <th class="lead"><strong>ID Factura</strong></th>
                        <th class="lead"><strong>Fecha de pago</strong></th>
                        <th class="lead"><strong>Importe</strong></th>
                        <th class="lead"><strong>Metodo de Pago</strong></th>
                    </tr>
                </thead>
                <tbody>
                    <?php                    
                    ...
                    foreach ($pagos as $pago) {
                        ...
                        echo "<td>" . htmlspecialchars($pago['id_factura']) . "</td>";
                        echo "<td>" . htmlspecialchars($pago['fecha_pago']) . "</td>";
                        echo "<td>" . htmlspecialchars($pago['importe']) . "</td>";
